...
export default function TeamPage() {
  return (
    <SiteChrome>
      <ProtectedShell
        title="Protected team workspace"
        description="Sign in to review team ownership, mentor guidance, and protected project operations."
      >
        <section className="sb-section">
          <div className="sb-container">
            <div className="sb-section-heading">
              ...
              <p>
                The repository now has a dedicated protected page for delivery roles, responsibilities, and the parts of the product that still need follow-through.
              </p>
            </div>
